...
public class MageAttack : MonoBehaviour
{
    ...
    [Header("Facing")]
    public Transform visualRoot;   // ���� UnitRoot
    ...
    void FireMagic(Transform target)
    {
        ...
        {
            Debug.LogError("MageAttack: magicProjectilePrefab�� ������� �ʾҽ��ϴ�.");
            return;
        }
        ...
        {
            Debug.LogError("MageAttack: MagicProjectile ������Ʈ�� �����ϴ�.");
        }
    }
