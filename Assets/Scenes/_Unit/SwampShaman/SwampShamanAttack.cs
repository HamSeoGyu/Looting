...
public class SwampShamanAttack : MonoBehaviour
{
    [Header("References")]
    public GameObject swampOrbProjectilePrefab;
    ...
    [Header("Stats")]
    public int directDamage = 3;        // 낮은 직격 피해
    public float attackCooldown = 2.2f; // 느림
